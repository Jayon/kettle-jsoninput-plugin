 ...
 * @version V1.0   
 */
public class RRJsonInputField implements Cloneable
{
	...
	public RRJsonInputField(String fieldname)
	{
		this.name           = fieldname;
		this.path          = "";
		this.length         = -1;
	...
	public RRJsonInputField(Node fnode) throws KettleValueException
    {
    ...
    public Object clone()
	{
		try
		{
			RRJsonInputField retval = (RRJsonInputField) super.clone();
